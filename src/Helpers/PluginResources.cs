namespace Loupedeck.SolidWorksPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.SolidWorksPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.SolidWorksPlugin.Resources.Resource.txt`.
